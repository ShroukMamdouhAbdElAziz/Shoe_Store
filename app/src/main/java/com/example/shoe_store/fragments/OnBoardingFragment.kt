...
import com.example.shoe_store.databinding.FragmentOnBoardingBinding
...
class OnBoardingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(layoutInflater, R.layout.fragment_on_boarding, container, false)
        return binding.root
    }
